...
class AlignDlib:
    ...
    def __init__(self, facePredictor):
        ...
        :param facePredictor: The path to dlib
        :type facePredictor: str
        """
        assert facePredictor is not None

        self.detector = get_frontal_face_detector()
        self.predictor = shape_predictor(facePredictor)
    ...
    def getLargestFaceBoundingBox(self, img, skipMulti):
        """
    ...
    def findLandmarks(self, rgbImg, bb):
        ...
        :type bb: dlib.rectangles
        :return: Detected landmark locations.
        :rtype: list of (cropped,y) tuples
        """
        assert rgbImg is not None
    ...
    def align(self, imgDim, rgbImg, bb=None, landmarks=None, landmarkIndices=INNER_EYES_AND_BOTTOM_LIP,
        ...
        :type landmarks: list of (cropped,y) tuples
